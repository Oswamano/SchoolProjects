//Matthew O'Connor HW2 Student Number 50000250
#include <iostream>
#include <string>
#include <vector>
#include <cmath>
...
/** When run In Java I get a nice output, when run on the timberlake system my output is aproximately a paragraph, I think it may have something to do with the differences between pointers and references and the differences between vectors and arrays? */
