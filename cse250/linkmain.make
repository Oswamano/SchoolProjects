...
LinkArg.o: LinkArg.cpp LinkArg.h  #lives in base directory
	$(CC) -c LinkArg.cpp

# LinkTemplate.o: LinkTemplate.cpp LinkTemplate.h   ## NO! with g++

ChainCLientMDO.o: ChainClientMDO.cpp PeekDeque3MDO.h StringWrap.h
	$(CC) -c ChainClient.cpp

ChainClientMDO: ChainClientMDO.o StringWrap.o
	$(CC) -o ChainCLientMDO ChainClientMDO.o StringWrap.o $(LIBS)
