...
public class Square extends cse115.graphics.Rectangle {
	private lab4.ColorHolder _holder;
	
	public Square(lab4.ColorHolder h) {
		_holder = h;
		...
		this.addMouseListener(new java.awt.event.MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Square.this.setColor(callGetColorOnColorHolder(_holder));
			}
		});
	}
	private java.awt.Color callGetColorOnColorHolder(lab4.ColorHolder b) {
