...
//		_drawingCanvas.setColor(java.awt.Color.WHITE);
		_window = new javax.swing.JFrame("CSE115 Spring 2012 Lab 4");
	...
	public void addSquareButton(lab4.SquareButton sb) {
		_squareButtonColumn.add(new MagicSquareButton(sb));
		_window.pack();
	}
	
	public void addCircleButton(lab4.CircleButton sb) {
		_circleButtonColumn.add(new MagicCircleButton(sb));
		_window.pack();
	}
	
	public void addColorButton(lab4.ColorButton cb) {
	...
	private class MagicSquareButton extends javax.swing.JButton {
		...
		private lab4.SquareButton _sb;
		public MagicSquareButton(lab4.SquareButton sb) {
			super("NEW SQUARE");
			this.setOpaque(true);
		...
		private void callButtonPressedOnButton(lab4.SquareButton b) {
	...
	private class MagicCircleButton extends javax.swing.JButton {
		private static final long serialVersionUID = 1L;
		private lab4.CircleButton _sb;
		public MagicCircleButton(lab4.CircleButton sb) {
			super("NEW CIRCLE");
			this.setOpaque(true);
			this.setBackground(java.awt.Color.WHITE);
			_sb = sb;
		...
		private void callButtonPressedOnButton(lab4.CircleButton b) {
			...
			try {
		        ...
		        try {
					...
					System.err.println("Hmm.  This shouldn't happen.  Please tell your instructor or TA that the second error occured for the "+className+".");
				} catch (IllegalAccessException e) {
					System.err.println("Hmm.  This shouldn't happen.  Please tell your instructor or TA that the third error occured for the "+className+".");
				} catch (InvocationTargetException e) {
					System.err.println("Hmm.  This shouldn't happen.  Please tell your instructor or TA that the fourth error occured for the "+className+".");
				}
			} catch (SecurityException e) {
				System.err.println("Hmm.  This shouldn't happen.  Please tell your instructor or TA that the first error occured for the "+className+".");
			} catch (NoSuchMethodException e) {
	...
	private class MagicColorButton extends javax.swing.JButton {
		private static final long serialVersionUID = 1L;
		private lab4.ColorButton _cb;
		public MagicColorButton(lab4.ColorButton cb) {
			super(" ");
			...
			try {
				...
				if (fields.length != 2) {
					System.err.println("Whoops!  You need to declare TWO instance variables in the ColorButton class, one of type java.awt.Color and one of type lab4.ColorHolder.  You declared "+fields.length+" instance variables.");
				}
				for (Field f : fields) {
					try {
				...
				try {
					...
					System.err.println("Hmm.  This shouldn't happen.  Please tell your instructor or TA that the second error occured when trying to access the instance variable of type "+fieldType+" in the "+className+" class.");
				} catch (IllegalAccessException e1) {
					System.err.println("Hmm.  This shouldn't happen.  Please tell your instructor or TA that the third error occured when trying to access the instance variable of type "+fieldType+" in the "+className+" class.");
				}
			} catch (SecurityException e1) {
				System.err.println("Hmm.  This shouldn't happen.  Please tell your instructor or TA that the first error occured when trying to access the instance variable of type "+fieldType+" in the "+className+" class.");
		...
		private void callButtonPressedOnButton(lab4.ColorButton b) {
	        final String className = "ColorButton";
	        final String methodName = "buttonPressed";
	        Method meth=null;
			try {
