// Matthew O'Connor Student number 50000250 homework 2 DequeTest
#include <iostream>
#include <string>
#include <vector>
#include <cmath>
...
class StringDeque{// Deque time
 ...
 vector<string>* elements; // its kind of like an array
   ...
   int rearSpace;
    int upperBound;  //CLASS INV: indexes space after item with greatest 
index
       public:
  StringDeque(int guaranteedCapacity){
   ...
   virtual bool isFull() const { return rearSpace == upperBound || 
frontItem == 0; }
